...
class TableTennisScorer:
    ...
    def _tts_worker_loop(self):
        ...
        try:
            ...
            self.tts_available = False
            print(f"Failed to initialize text-to-speech engine in worker: {e}")
            return
        ...
        while not self.tts_stop_event.is_set():
            ...
            try:
                ...
                try:
                    ...
                    self.tts_available = False
                    print(f"TTS disabled due to repeated initialization failure: {reinit_err}")
                    break
